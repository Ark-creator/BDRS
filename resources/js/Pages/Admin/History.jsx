                                        ...
                                        return (
                                            <Link
                                                ...
                                                className={clsx(
                                                    ...
                                                    !link.url ? 'text-gray-400 cursor-not-allowed' : 'text-gray-700 dark:text-gray-300 hover:bg-sky-100 dark:hover:bg-gray-700',
                                                    link.active ? 'bg-blue-600 text-white font-semibold shadow-md hover:bg-blue-700' : 'bg-white dark:bg-gray-800'
                                                )}
                                            >
                                                {label}
                                            </Link>
