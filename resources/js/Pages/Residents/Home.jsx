...
                    { element: '#request-tour-button', popover: { title: 'Start The Tour', description: 'Click this button anytime for a guided tour on how to request documents.' } },
...
                                        <div className="group flex flex-col items-center rounded-2xl bg-white p-8 text-center">
...
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-10 w-10"><path strokeLinecap="round" strokeLinejoin="round" d="M15.042 21.672L13.684 16.6m0 0l-2.51 2.225.569-9.47 5.227 7.917-3.286-.672zM12 2.25a8.25 8.25 0 00-8.25 8.25c0 1.913.64 3.705 1.75 5.25l.224.332a23.102 23.102 0 014.256 6.175 1.5 1.5 0 002.542 0 23.102 23.102 0 014.256-6.175l.224-.332a8.25 8.25 0 001.75-5.25A8.25 8.25 0 0012 2.25z" /></svg>

                                            </div>

                                            <h3 className="mt-6 text-xl font-semibold text-gray-900">Click Request Button</h3>
...
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-10 w-10"><path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" /></svg>
...
                                        {documentTypes && documentTypes.length > 0 && documentTypes.map((docType, index) => (

                                            <motion.div

                                                id={index === 0 ? 'document-card-example' : undefined}
...
                    id="request-tour-button"

                    onClick={startTour}

                    aria-label="Start a tour on how to request documents"

                    className="fixed bottom-8 right-8 z-50 flex items-center gap-3 px-5 py-3 bg-blue-600 text-white font-semibold rounded-full shadow-lg hover:bg-blue-700 hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-300"

                >

                

                    <span>How to Request</span> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6">
