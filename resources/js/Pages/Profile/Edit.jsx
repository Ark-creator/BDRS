...
const SettingsCard = ({ title, description, children, variant = 'default' }) => {
    ...
    return (
        ...
        >
            ...
            <div className="  border-gray-200/80 dark:border-slate-700 ">
                {children}
            </div>
        </motion.div>
    );
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
                            ...
                            <div className="lg:col-span-3">
                                <AnimatePresence mode="wait">
                                    ...
                                    {activeTab === 'verification' && (
                                        <SettingsCard key="verification" title="Uploaded Credentials" description="These are the images you provided during registration. Click to enlarge.">
                                            {(userProfile && (userProfile.face_image_path || userProfile.valid_id_front_path)) ? (
                                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-center mt-6">
                                    ...
                                    {activeTab === 'password' && (
                                        <SettingsCard key="password">
                                            <UpdatePasswordForm />
                                        </SettingsCard>
                                    )}

                                    {activeTab === 'danger' && (
                                        <SettingsCard key="danger" variant="danger">
                                            <DeleteUserForm />
                                        </SettingsCard>
                                    )}
                                </AnimatePresence>
